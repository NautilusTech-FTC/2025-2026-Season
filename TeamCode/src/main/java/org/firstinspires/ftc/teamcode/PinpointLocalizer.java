...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1868.305195101019; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3441.154550441893; // x position of the perpendicular encoder (in tick units)
    }
