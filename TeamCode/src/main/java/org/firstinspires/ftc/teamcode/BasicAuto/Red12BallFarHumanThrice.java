...
@Autonomous(name="RED 6 Ball Far HUMAN PLAYER x3", group="6 Ball Autos")
@Config
public class Red12BallFarHumanThrice extends LinearOpMode {
    ...
    public void runOpMode () {
        ...
        TrajectoryActionBuilder hpExtra = aim.endTrajectory().fresh()
                .setTangent(0)
                .splineToSplineHeading(new Pose2d(stealX+1, 25, Math.PI/2), Math.PI/2, new TranslationalVelConstraint(75.0), new ProfileAccelConstraint(-75, 75))
                .setTangent(Math.PI/2)
